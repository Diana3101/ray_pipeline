...
python3 train.py --img-size 640 --cfg cfg/training/yolov7.yaml --hyp data/hyp.scratch.custom.yaml --batch 4 --epochs 1 --data data/road_sign_data.yaml --weights yolov7.pt --workers 12 --name yolo_road_data
# convert xml to txt
# finetune p6 models
